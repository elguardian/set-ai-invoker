...
import org.jboss.set.agent.invoker.collector.Filter;
import org.jboss.set.agent.invoker.collector.FilterOperator;
import org.jboss.set.agent.invoker.github.dto.GitHubEvent;
import org.jboss.set.agent.invoker.github.dto.GitHubEventPayload;
import org.jboss.set.agent.invoker.github.dto.GitHubPullRequest;
...
public class GitHubCollector implements EventCollector {
    ...
    private static boolean matchesFilters(PullRequestEvent event, org.jboss.set.agent.invoker.collector.Filters filters) {
