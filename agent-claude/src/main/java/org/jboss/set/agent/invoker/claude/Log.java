...
@MessageLogger(projectCode = "SETAIAC")
interface Log extends BasicLogger {

    Log LOG = Logger.getMessageLogger(Log.class, "org.jboss.set.agent.invoker.claude");

    @LogMessage(level = Logger.Level.WARN)
    @Message(id = 1, value = "claude CLI exited with code %d")
