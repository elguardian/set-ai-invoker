...
/**
 * Handles Claude CLI stream-json events.
 *
 * <p>Closes stdin when the {@code result} event arrives (end of a conversation turn),
 * which causes Claude to exit cleanly. Tool-use events are logged; actual tool
 * execution is handled internally by Claude CLI (built-ins) or via MCP servers.
 *
 ...
 */
public class ClaudeAgentEventDispatch implements AgentEventDispatch {
